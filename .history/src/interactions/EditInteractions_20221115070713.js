...
export default function EditInteractions() {
  ...
  const loadCandidate = async () => {
    ...
    setID(result.candidateId); //TODO: TODOTODODO
  };
    ...
    <div className="container">
      <div className="row">
        <div className="col-md6 border rounded p-4 mt-3 shadow">
          <h2 text-center="true">Edit Candidate</h2>
          <form onSubmit={(e) => onSubmit(e)}>
            ...
            <div className="d-grid gap-2 d-md-flex justify-content-md-end col-18 mx-auto">
              <button type="submit" className="btn btn-success" onClick={()=>console.log(candidateId)}>
                EDİT
              </button>
