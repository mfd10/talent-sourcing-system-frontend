              ...
              <div className="row align-items-start p-4">
                ...
                <div className="col">
                  <input
                    ...
                    onChange={(e) => onInputChange(e)}
                  ></input>
                  <label class="form-check-label" for="1">Sourced</label>
                  ...
                  <input
                    ...
                    onChange={(e) => onInputChange(e)}
                  ></input>
                  <label class="form-check-label" for="2">Interviewing</label>
                  ...
                  <input
                    ...
                    onChange={(e) => onInputChange(e)}
                  ></input>
                  <label class="form-check-label" for="3">Offer Send</label>
                  ...
                  <input
                    ...
                    onChange={(e) => onInputChange(e)}
                  ></input>
                  <label class="form-check-label" for="4">Hired</label>
