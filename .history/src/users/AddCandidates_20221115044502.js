        ...
        <div className="col-md6 border rounded p-4 mt-3 shadow">
          ...
          <form onSubmit={(e) => onSubmit(e)}>
            ...
            <div className="mb-2">
                ...
                <div className="col">
                  <input type="radio" value="SOURCED" name="status" onChange={(e) => onInputChange(e)}>Sourced</input>
                  <input type="radio" value="INTERVIEWING" name="status" onChange={(e) => onInputChange(e)}>Interviewing</input>
                  <input type="radio" value="OFFER_SEND" name="status" onChange={(e) => onInputChange(e)}>Offer Send</input>
                  <input type="radio" value="HIRED" name="status" onChange={(e) => onInputChange(e)}>Hired</input>
